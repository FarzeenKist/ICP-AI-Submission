...
import { idlFactory as quizIDL, canisterId as QUIZ_CANISTER_ID } from "../../../declarations/submission_backend/index";
import { idlFactory as ledgerIDL } from "../../../declarations/ledger_canister/ledger_canister.did.js";

const LEDGER_CANISTER_ID = "ryjl3-tyaaa-aaaaa-aaaba-cai";
const HOST = "http://localhost:4943";

export async function getQuizCanister() {
    return await getCanister(QUIZ_CANISTER_ID, quizIDL);
}
